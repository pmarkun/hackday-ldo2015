...
IV - compromisso da entidade beneficiada de disponibilizar ao cidadão, na sua página na internet e em formato aberto ou, na falta desta, em sua sede, consulta a integra do convênio ou instrumento congênere, com cronograma de execução, orçamento físco-financeiro e o detalhamento da aplicação dos recursos;

V -  compromisso da entidade beneficiada de disponibilizar ao cidadão, na sua página na internet, blog em formato aberto com informações atualizadas relativas a execução e andamento do projeto tais como vídeos, fotos, textos;

VI - apresentação da prestação de contas de recursos anteriormente recebidos, nos prazos e nas condições fixados na legislação e inexistência de prestação de contas rejeitada;
...
VIII - comprovação pela entidade da regularidade do mandato de sua diretoria, inscrição no CNPJ e apresentação de declaração de funcionamento regular nos últimos três anos emitida no exercício de 2014;
...
XII - demonstração, por parte da entidade, de capacidade gerencial, operacional e técnica para desenvolver as atividades; e
...
§ 1o A indicação nominal deve incluir informação geográfica em formato aberto compátivel com o padrão do IBGE para malha municipal.

§ 2o Os indicadores socioeconômicos utilizados deverão acompanhar link para página na internet contendo no mínimo:

I - Disponbilização dos microdados que geraram o indicador em formato aberto e legível por máquina e;
II - Disponibilização da metodologia de pesquisa utilizada com licença aberta.
...
o) financiamento a projetos e empresas emergentes de serviços de tecnologia baseadas em software livre que se proponham a utilizar essas tecnologias e o conhecimento como elementos do seu esforço de inovação para o desenvolvimento social, a transparência pública e a participação social.
